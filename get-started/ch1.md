...
![Interpreting a script to execute it](images/fig1.png)_Fig. 1: Interpreted/Scripted Execution_\
\
...
![Parsing, compiling, and executing a program](images/fig2.png)_Fig. 2: Parsing + Compilation + Execution_\
\
...
![Steps of JS compilation and execution](images/fig3.png)_Fig. 3: Parsing, Compiling, and Executing JS_\
\
