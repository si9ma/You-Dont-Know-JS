...
![Function instances linked to scopes via closure](images/fig4.png)_Fig. 4: Visualizing Closures_\
\
...
![Function instances linked to scopes via closure](images/fig4.png)_Fig. 4 (repeat): Visualizing Closures_\
\
...
![Function instances inside scopes via closure, linked to by references](images/fig5.png)_Fig. 5: Visualizing Closures (Alternative)_\
\
